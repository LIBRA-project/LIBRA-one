...
def build_libra_xl(salt_material=flibe_nat,
    ...
    vacuum_insulation_inner_cyl = openmc.ZCylinder(r=multiplier_outer_cyl.r + (1/8)*2.54)
    ...
    reflector_bot_plane = openmc.ZPlane(support_plate_bot_plane.z0 - reflector_thickness)
    ...
    inner_side_wall_out_reg = +inner_cyl_1 & -inner_cyl_2 \
                      & +z_plane_2 & -tank_top_cover_plane_1
    inner_side_wall_out_cell = openmc.Cell(region=inner_side_wall_out_reg,
                                         fill=inconel625,
                                         name='inner side wall out')


    outer_side_wall_out_reg = +outer_cyl_1 & -outer_cyl_2 \
                        & +z_plane_2 & -tank_top_cover_plane_1
    outer_side_wall_out_cell = openmc.Cell(region=outer_side_wall_out_reg,
                                        fill=inconel625,
                                        name='outer side wall out')
    
    
    bot_wall_out_reg = -outer_cyl_2 & +inner_cyl_1 \
                     & +z_plane_1 & -z_plane_2
    bot_wall_out_cell = openmc.Cell(region=bot_wall_out_reg,
                              fill=inconel625,
                              name='bottom outer wall')
    
    ## heater reentrant tubes
    heater_reentrant_1_reg = (+heater_reentrant_1_in_cyl & -heater_reentrant_1_out_cyl \
                            & -tank_top_cover_plane_2 & +heater_reentrant_bot_plane_2) \
    ...
    heater_fill_1_reg = -heater_reentrant_1_in_cyl & -tank_top_cover_plane_2 & +heater_reentrant_bot_plane_2
    heater_fill_1_cell = openmc.Cell(region=heater_fill_1_reg, fill=air, name='Heater 1') 

    heater_overall_1_reg = -heater_reentrant_1_out_cyl & +heater_reentrant_bot_plane_1 & -tank_top_cover_plane_2
    ...
    heater_fill_2_reg = -heater_reentrant_2_in_cyl & -tank_top_cover_plane_2 & +heater_reentrant_bot_plane_2
    heater_fill_2_cell = openmc.Cell(region=heater_fill_2_reg, fill=air, name='Heater 2')

    heater_overall_2_reg = -heater_reentrant_2_out_cyl & +heater_reentrant_bot_plane_1 & -tank_top_cover_plane_2
    ...
    heater_fill_3_reg = -heater_reentrant_3_in_cyl & -tank_top_cover_plane_2 & +heater_reentrant_bot_plane_2
    heater_fill_3_cell = openmc.Cell(region=heater_fill_3_reg, fill=air, name='Heater 3') 

    heater_overall_3_reg = -heater_reentrant_3_out_cyl & +heater_reentrant_bot_plane_1 & -tank_top_cover_plane_2
    

    ## Inner tank top cover
    inner_tank_cover_reg = +tank_top_cover_plane_1 & -tank_top_cover_plane_2 \
                            & +inner_cyl_1 & -outer_cyl_2\
    ...
    salt_reg = +inner_cyl_2 & -outer_cyl_1 \
                & +z_plane_2 & -salt_top_plane \
    ...
    salt_vol = (
        (np.pi * (salt_top_plane.z0 - z_plane_2.z0) * (outer_cyl_1.r**2 - inner_cyl_2.r**2))
        - 12 * np.pi * (salt_top_plane.z0 - heater_reentrant_bot_plane_1.z0) * heater_reentrant_1_out_cyl.r**2
    )
    ...
    ## Inner tank air
    inner_tank_air_reg = +inner_cyl_2 & -outer_cyl_1 \
    ...
    vacuum_insulation_inner_wall_reg = (+multiplier_outer_cyl & -vacuum_insulation_inner_cyl
                                        & +reflector_bot_plane & -tank_top_cover_plane_2)
    vacuum_insulation_inner_wall_cell = openmc.Cell(region=vacuum_insulation_inner_wall_reg,
                                                    fill=SS316,
                                                    name='Vacuum Insulation Inner Wall')
    
    vacuum_insulation_reg = (+vacuum_insulation_inner_cyl & -vacuum_insulation_outer_cyl
                             & +reflector_bot_plane & -tank_top_cover_plane_2)
    vacuum_insulation_cell = openmc.Cell(region=vacuum_insulation_reg,
                                         fill=None,
                                         name='Vacuum Insulation')
    
    vacuum_insulation_outer_wall_reg = (+vacuum_insulation_outer_cyl & -inner_cyl_1
                                        & +reflector_bot_plane & -tank_top_cover_plane_2)
    vacuum_insulation_outer_wall_cell = openmc.Cell(region=vacuum_insulation_outer_wall_reg,
                                                    fill=SS316,
                                                    name='Vacuum Insulation Outer Wall')

    center_air_reg = -multiplier_outer_cyl & +reflector_bot_plane & -tank_top_cover_plane_2 & ~multiplier_reg
    center_air_cell = openmc.Cell(region=center_air_reg, fill=air, name='center cylinder air')
    ...
    support_plate_reg = +inner_cyl_1 & -outer_cyl_2 & +support_plate_bot_plane & -z_plane_1
    support_plate_cell = openmc.Cell(region=support_plate_reg, fill=steel_lowC, name='Support Plate')

    reflector_reg = (+outer_cyl_2 & -reflector_outer_cyl & -tank_top_cover_plane_2 & +support_plate_bot_plane) \
                | (-reflector_outer_cyl & +tank_top_cover_plane_2 & -reflector_top_plane) \
                | (-reflector_outer_cyl & +inner_cyl_1 & -support_plate_bot_plane & +reflector_bot_plane)
    reflector_cell = openmc.Cell(region=reflector_reg, fill=reflector_material, name='Reflector')


    libra_quarter_1_reg = -libra_out_cyl & +libra_bot_plane & -libra_top_plane & +x0_plane & +y0_plane

    libra_quarter_1_cells = [outer_side_wall_out_cell,
    ...
    return libra_reg, libra_system_cell, materials, src, salt_cell, salt_material, salt_vol
